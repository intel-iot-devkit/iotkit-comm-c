...
/** @file test_iotkitpubsub_client_unsubscribe_success.c
...
int main (void)
{
    ...
    if (result == MQTTASYNC_SUCCESS) {
        printf("Successfully Connected to iotkit-agent's broker\n");
        ...
        printf("Test Failed: Could not connect to iotkit-agent's broker\n");
    }
